...
function rootReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case FILTER_GENRES:
            ...
            let genreGames = genderGames.filter((game) => game.genres.includes(action.payload))
            return{
                ...state,
        ...
        case GAMES_ORIGIN:
            ...
            if (action.payload === 'api') {
                const apiGames = originGames.filter((game) => typeof game.id === 'number')
                return {
                    ...state,
            ...
            if (action.payload === 'db') {
                const dbGames = originGames.filter((game) => typeof game.id !== 'number')
                return {
                    ...state,
